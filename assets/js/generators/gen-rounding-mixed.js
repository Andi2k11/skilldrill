...
window.roundingGenerators['rounding-mixed']=(function(){
 ...
 return {generate:function(p){var q=[],count=p.questionCount||15,types=p.numberTypes||['integer','decimal'];for(var i=0;i<count;i++)q.push(choice(types)==='decimal'?makeDec(p.decimal):makeInt(p.integer));return q;}};
})();
